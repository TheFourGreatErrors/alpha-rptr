...
class BitMexStub(Stub, BitMex): 
    ...
    def on_update(self, bin_size, strategy):
        ...
        self.__override_strategy = Stub.override_strategy(__override_strategy).__get__(self, BitMexStub)

        # Call the 'on_update' function of the 'Bybit' class, passing 'bin_size' and the overridden '__override_strategy'.
        BitMex.on_update(self, bin_size, self.__override_strategy)
