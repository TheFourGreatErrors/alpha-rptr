...
class BitMexBackTest(BackTest, BitMexStub):      
    ...
    def __init__(self, account, pair):
        ...
        """        
        # Call the constructor of the BitMexStub parent class to initialize the instance.  
        BitMexStub.__init__(self, account, pair=pair, threading=False)        
    ...
    def on_update(self, bin_size, strategy):
        ...
        self.set_paths('bitmex', pair=self.pair, bin_size=self.bin_size)  
    ...
    def download_data(self, bin_size, start_time, end_time):
        ...
        source = None
        is_last_fetch = False          
        file = self.OHLC_FILENAME #OHLC_FILENAME.format("BitMEX", self.pair, self.bin_size)
