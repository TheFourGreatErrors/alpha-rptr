...
class BybitBackTest(BackTest, BybitStub):   
    ...
    def __init__(self, account, pair):
        ...
        """        
        # Call the constructor of the BybitStub parent class to initialize the instance.  
    ...
    def download_data(self, bin_size, start_time, end_time):
        ...
        source = None
        is_last_fetch = False
        file = self.OHLC_FILENAME #OHLC_FILENAME.format("bybit", self.pair, self.bin_size)
